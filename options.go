...
func (o *Options) CLI() serpent.OptionSet {
	options := serpent.OptionSet{
		...
		},
		{
			...
			Env:   withPrefix("BASE_IMAGE_CACHE_DIR"),
		...
		},
		{
			...
			Env:   withPrefix("LAYER_CACHE_DIR"),
		...
		},
		{
			...
			Env:   withPrefix("DEVCONTAINER_DIR"),
		...
		},
		{
			...
			Env:   withPrefix("DEVCONTAINER_JSON_PATH"),
		...
		},
		{
			...
			Env:   withPrefix("DOCKERFILE_PATH"),
		...
		},
		{
			...
			Env:   withPrefix("BUILD_CONTEXT_PATH"),
		...
		},
		{
			...
			Env:   withPrefix("DOCKER_CONFIG_BASE64"),
		...
		},
		{
			...
			Env:   withPrefix("EXIT_ON_BUILD_FAILURE"),
		...
		},
		{
			...
			Env:         withPrefix("GIT_CLONE_SINGLE_BRANCH"),
		...
		},
		{
			...
			Env:         withPrefix("GIT_SSH_PRIVATE_KEY_PATH"),
		...
		},
		{
			...
			Env:   withPrefix("SSL_CERT_BASE64"),
		...
		},
		{
			...
			Env:   withPrefix("EXPORT_ENV_FILE"),
		...
		},
		{
			...
			Env:   withPrefix("POST_START_SCRIPT_PATH"),
