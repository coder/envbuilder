...
require (
	...
	github.com/coder/coder/v2 v2.13.3
...
require (
	...
	github.com/coder/terraform-provider-coder v1.0.1 // indirect
	...
	gvisor.dev/gvisor v0.0.0-20240806092850-7bcc2b016742 // indirect
	inet.af/peercred v0.0.0-20210906144145-0893ea02156a // indirect
	nhooyr.io/websocket v1.8.11 // indirect
	storj.io/drpc v0.0.34 // indirect
	tailscale.com v1.70.0 // indirect
)
